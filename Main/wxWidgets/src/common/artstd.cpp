...
#include "../../art/luafile.xpm"
#include "../../art/hfile.xpm"
#include "../../art/cfile.xpm"
#include "../../art/cppfile.xpm"
#include "../../art/pyfile.xpm"
#include "../../art/shfile.xpm"
#include "../../art/infile.xpm"
#include "../../art/txtfile.xpm"
#include "../../art/forfile.xpm"
#include "../../art/mfile.xpm"
#include "../../art/makefile.xpm"
//
...
wxBitmap wxDefaultArtProvider_CreateBitmap(const wxArtID& id)
{
    ...
    // [:COMET:]:150228:MOD: add file types
    ART(wxART_LUA_FILE, luafile)
    ART(wxART_H_FILE, hfile)
    ART(wxART_C_FILE, cfile)
    ART(wxART_CPP_FILE, cppfile)
    ART(wxART_IN_FILE, infile)
    ART(wxART_PY_FILE, pyfile)
    ART(wxART_SH_FILE, shfile)
    ART(wxART_TXT_FILE, txtfile)
    ART(wxART_FOR_FILE, forfile)
    ART(wxART_M_FILE, mfile)
    ART(wxART_MAK_FILE, makefile)
    //
