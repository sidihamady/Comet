                                       ...
                                       int width)
{
    ...
    dc->GetTextExtent(text, &w, &h);
     // [:COMET:]:20150216: Under GTK, correct the vertical alignment bug
     dc->GetTextExtent(_T("Q"), NULL, &hh);
     //
     const wxCoord y = yMid - (hh + 1) / 2;

    wxDCClipper clipper(*dc, x, y, width, hh);
