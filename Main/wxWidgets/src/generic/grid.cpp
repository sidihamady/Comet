                 ...
                 !SendEvent( wxEVT_GRID_LABEL_LEFT_CLICK, row, -1, event ) )
            {
                ...
                if ( m_selection )
                {
                    ...
                    else
                    {
                     ...
                     // [:COMET:]:20151101: save m_currentCellCoords
                     this->SetGridCursor(row, 0);
...
void wxGrid::ProcessGridCellMouseEvent( wxMouseEvent& event )
{
    ...
    if ( event.LeftDown() && coords != wxGridNoCellCoords )
    {
     ...
     // [:COMET:]:20151031: clear selection if click outside
     else if (event.LeftDown() && coords == wxGridNoCellCoords) {
         this->ClearSelection();
     }

     // [:COMET:]:20151031: context menu
...
// [:COMET:]:20151031: context menu
void wxGrid::OnOutsideRightClick(wxMouseEvent& WXUNUSED(tEvent))
{
    // nothing. derived class will overload it.
}
                               ...
                               int textOrientation)
{
    ...
    for ( size_t l = 0; l < nLines; l++ )
    {
        ...
        dc.GetTextExtent(line, &lineWidth, &lineHeight);
          // [:COMET:]:20151101: row height and col width based on text were too small
          lineHeight += 4;
          lineWidth += 2;
