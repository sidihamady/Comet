...
// Modified by:
// Created:     2004-08-22
// RCS-ID:      $Id: artgtk.cpp 49926 2007-11-13 20:04:09Z PC $
...
// [:COMET:]:150302:MOD: add custom icons
...
static const char *wxArtIDToStock(const wxArtID& id)
{
    ...
    //ART(wxART_NEW_DIR,                             )
     ...
     // [:COMET:]:150302:MOD: add custom icons
     ART(wxART_FOLDER, (const char*) folder_xpm)
     ART(wxART_FOLDER_OPEN, (const char*) folder_open_xpm)
     //
     /*
#ifdef __WXGTK24__
