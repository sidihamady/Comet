                          ...
                          const wxString &name )
{
    ...
    {  
     ...
     // [:COMET:]:160218: right alight in GTK
     if (GTK_JUSTIFY_RIGHT == justify) {
         gtk_label_set_ellipsize(GTK_LABEL(m_widget), PANGO_ELLIPSIZE_START);
     }
    ...
    gtk_misc_set_alignment(GTK_MISC(m_widget), labelAlignments[justify], 0.0);
     ...
     // [:COMET:]:160218: right alight in GTK
     gtk_label_set_line_wrap(GTK_LABEL(m_widget), (GTK_JUSTIFY_RIGHT != justify));
