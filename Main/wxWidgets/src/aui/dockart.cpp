...
wxAuiDefaultDockArt::wxAuiDefaultDockArt()
{
    ...
    {
        base_colour = wxAuiStepColour(base_colour, 97);
    }
     // <<

    m_base_colour = base_colour;
    wxColor darker1_colour = wxAuiStepColour(base_colour, 85);
    wxColor darker2_colour = wxAuiStepColour(base_colour, 80);
    wxColor darker3_colour = wxAuiStepColour(base_colour, 75);
    wxColor darker4_colour = wxAuiStepColour(base_colour, 70);
    wxColor darker5_colour = wxAuiStepColour(base_colour, 65);
    ...
    m_active_caption_gradient_colour = wxAuiLightContrastColour(wxSystemSettings::GetColour(wxSYS_COLOUR_HIGHLIGHT));
     m_active_caption_text_colour = wxSystemSettings::GetColour(wxSYS_COLOUR_CAPTIONTEXT);//wxSystemSettings::GetColour(wxSYS_COLOUR_HIGHLIGHTTEXT);
    m_inactive_caption_colour = darker1_colour;
    m_inactive_caption_gradient_colour = wxAuiStepColour(base_colour, 97);
    m_inactive_caption_text_colour = wxColour(30,80,120); //wxSystemSettings::GetColour(wxSYS_COLOUR_INACTIVECAPTIONTEXT);
