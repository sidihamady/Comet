...
#define wxART_LUA_FILE            wxART_MAKE_ART_ID(wxART_LUA_FILE)
#define wxART_H_FILE              wxART_MAKE_ART_ID(wxART_H_FILE)
#define wxART_C_FILE              wxART_MAKE_ART_ID(wxART_C_FILE)
#define wxART_CPP_FILE            wxART_MAKE_ART_ID(wxART_CPP_FILE)
#define wxART_IN_FILE             wxART_MAKE_ART_ID(wxART_IN_FILE)
#define wxART_PY_FILE             wxART_MAKE_ART_ID(wxART_PY_FILE)
#define wxART_SH_FILE             wxART_MAKE_ART_ID(wxART_SH_FILE)
#define wxART_TXT_FILE            wxART_MAKE_ART_ID(wxART_TXT_FILE)
#define wxART_FOR_FILE            wxART_MAKE_ART_ID(wxART_FOR_FILE)
#define wxART_M_FILE              wxART_MAKE_ART_ID(wxART_M_FILE)
#define wxART_MAK_FILE            wxART_MAKE_ART_ID(wxART_MAK_FILE)
//
