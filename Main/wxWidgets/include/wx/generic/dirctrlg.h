...
public:
    ...
    virtual void CollapseTree();
     ...
     // [:COMET:]:151026:MOD: save and restore tree expand state
     virtual void SaveTreeItemState();
     virtual void SaveTreeState();
     virtual void RestoreTreeState();
...
private:
    ...
    wxDirFilterListCtrl* m_filterListCtrl;
     ...
     wxString        m_strNoExtName;

     // [:COMET:]:151026:MOD: save the expanded item path
     wxString m_expandedPath;
