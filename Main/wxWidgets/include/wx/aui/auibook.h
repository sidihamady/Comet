...
public:
    ...
    bool ButtonHitTestLeft(int x, int y, wxAuiTabContainerButton** hit) const;
    ...
    bool IsTabVisible(int tabPage, int tabOffset, wxDC* dc, wxWindow* wnd);
     ...
     bool IsInsertingPage(void)
     {
         return m_bInsertingPage;
     }
     void SetInsertingPage(bool bInsertingPage)
     {
         m_bInsertingPage = bInsertingPage;
     }
...
public:
    ...
    size_t SetSelection(size_t new_page, bool bFocus = true);
    int GetSelection() const;

    virtual void Split(size_t page, int direction);

     // [:COMET:]:20141230
     void MakeSelectionVisible(void);
    ...
    bool ShowWindowMenu();
          ...
          bool IsDeletingAll(void)
     {
         return m_bDeletingAll;
     }
     void SetDeletingAll(bool bDeletingAll)
     {
         m_bDeletingAll = bDeletingAll;
     }
...
protected:
 ...
 public:
    ...
    void DoMovePage(int src_idx, int dest_idx);

         // [:COMET:] previous selected page
      int GetPrevSelected(void)
     {
         return m_iPrevSelected;
     }
     void SetPrevSelected(int iPrevSelected)
     {
         m_iPrevSelected = iPrevSelected;
     }
...
protected:
    ...
    void OnTabFileList(wxCommandEvent& evt);
    void OnTabMainFileList(wxCommandEvent& evt);
...
BEGIN_DECLARE_EVENT_TYPES()
    ...
    DECLARE_EXPORTED_EVENT_TYPE(WXDLLIMPEXP_AUI, wxEVT_COMMAND_AUINOTEBOOK_FILELIST, 0)
    DECLARE_EXPORTED_EVENT_TYPE(WXDLLIMPEXP_AUI, wxEVT_COMMAND_AUINOTEBOOK_MAINFILELIST, 0)
#endif
...
#define EVT_AUINOTEBOOK_FILELIST(winid, fn) \
    wx__DECLARE_EVT1(wxEVT_COMMAND_AUINOTEBOOK_FILELIST, winid, wxAuiNotebookEventHandler(fn))
#define EVT_AUINOTEBOOK_MAINFILELIST(winid, fn) \
    wx__DECLARE_EVT1(wxEVT_COMMAND_AUINOTEBOOK_MAINFILELIST, winid, wxAuiNotebookEventHandler(fn))
#endif
