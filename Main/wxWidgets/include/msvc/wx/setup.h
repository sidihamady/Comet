...
// explicitly!
             ...
             #ifdef _DEBUG
                #ifdef _WIN64
                    #include "../../../../output/Windows64/lib/wx/mswud/wx/setup.h"
                #else
                    #include "../../../../output/Windows32/lib/wx/mswud/wx/setup.h"
                #endif
            #else
                #ifdef _WIN64
                    #include "../../../../output/Windows64/lib/wx/mswu/wx/setup.h"
                #else
                    #include "../../../../output/Windows32/lib/wx/mswu/wx/setup.h"
                #endif
            #endif
        #else
            #ifdef _DEBUG
            ...
            #ifdef _DEBUG
                #ifdef _WIN64
                    #include "../../../lib64/vc_dll/mswd/wx/setup.h"
                #else
                    #include "../../../lib32/vc_dll/mswd/wx/setup.h"
                #endif
            #else
                #ifdef _WIN64
                    #include "../../../lib64/vc_dll/msw/wx/setup.h"
                #else
                    #include "../../../lib32/vc_dll/msw/wx/setup.h"
                #endif
            #endif
        #else // static lib
            #ifdef _DEBUG
                #ifdef _WIN64
                    #include "../../../lib64/vc_lib/mswd/wx/setup.h"
                #else
                    #include "../../../lib32/vc_lib/mswd/wx/setup.h"
                #endif
            #else
                #ifdef _WIN64
                    #include "../../../lib64/vc_lib/msw/wx/setup.h"
                #else
                    #include "../../../lib32/vc_lib/msw/wx/setup.h"
                #endif
            #endif
        #endif // shared/static
