...
void CallTip::PaintCT(Surface *surfaceWindow) {
	...
	surfaceWindow->PenColour(colourShade.allocated = ColourAllocated(ColourDesired(0x7f, 0xa9, 0xcd).AsLong()));
	surfaceWindow->LineTo(rcClientSize.right - 1, rcClientSize.bottom - 1);
	surfaceWindow->LineTo(rcClientSize.right - 1, 0);
	surfaceWindow->PenColour(colourLight.allocated = ColourAllocated(ColourDesired(0x7f, 0xa9, 0xcd).AsLong()));
