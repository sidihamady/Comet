...
// [:COMET:]:20150130: draw character with the ad hoc colors
void LineMarker::DrawChar(Surface *surface, PRectangle &rcWhole, Font &fontForCharacter, ColourAllocated foreT, ColourAllocated backT) {
    ...
    surface->DrawTextClipped(rc, fontForCharacter, rc.top,
        character, 1, foreT, backT);
}
void LineMarker::DrawBack(Surface *surface, PRectangle &rcWhole, ColourAllocated backT) {
    if (markType < SC_MARK_CHARACTER) {
        return;
    }
    surface->FillRectangle(rcWhole, backT);
}
//
