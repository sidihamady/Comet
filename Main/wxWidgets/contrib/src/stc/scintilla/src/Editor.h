...
protected:    // ScintillaBase subclass needs access to much of Editor
    ...
    ColourAllocated clrBackModified;
    ColourAllocated clrBackSaved;
    ColourAllocated clrBackFind;
    ColourAllocated clrBackError;
    //
    ...
    * and then the foreground. This avoids chopping off characters that overlap the next run. */
    ...
    // [:COMET:]:20150123:
    bool modeScriptConsole;
    // Darken or lighten color (Darken if iDelta < 0)
    long normalizeColor(long iColor, long iDelta);
    long modifyColor(long iColor, int iComp, long iDelta);
    //
...
public:
    ...
    void setMarkersColors(unsigned long lBackModified, unsigned long lBackSaved, unsigned long lBackFind, unsigned long lBackError);
    void getMarkersColors(unsigned long *lBackModified, unsigned long *lBackSaved, unsigned long *lBackFind, unsigned long *lBackError);
    //
};
