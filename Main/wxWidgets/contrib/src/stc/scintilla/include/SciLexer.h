...
#define SCLEX_COMET 107
#define SCE_COMET_DEFAULT 0
#define SCE_COMET_COMMENT 1
#define SCE_COMET_COMMAND 2
#define SCE_COMET_NUMBER 3
#define SCE_COMET_KEYWORD 4
#define SCE_COMET_STRING 5
#define SCE_COMET_OPERATOR 6
#define SCE_COMET_IDENTIFIER 7
#define SCE_COMET_DOUBLEQUOTESTRING 8
//

// [:COMET:]:160207:MOD: add SCLEX_SOLIS
#define SCLEX_SOLIS 108
#define SCE_SOLIS_DEFAULT 0
#define SCE_SOLIS_COMMENT 1
#define SCE_SOLIS_COMMENTLINE 2
#define SCE_SOLIS_COMMAND 3
#define SCE_SOLIS_NUMBER 4
#define SCE_SOLIS_KEYWORD 5
#define SCE_SOLIS_KEYWORD2 6
#define SCE_SOLIS_STRING 7
#define SCE_SOLIS_OPERATOR 8
#define SCE_SOLIS_IDENTIFIER 9
#define SCE_SOLIS_ERROR 10
