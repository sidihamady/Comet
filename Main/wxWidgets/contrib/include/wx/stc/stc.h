...
//
// Created:     13-Jan-2000
// RCS-ID:      $Id: stc.h 66923 2011-02-16 22:37:48Z JS $
...
#define wxSTC_STYLE_FOLDINGLINE 39
#define wxSTC_STYLE_LASTPREDEFINED 40
...
#define wxSTC_LEX_COMET 107
#define wxSTC_COMET_DEFAULT 0
#define wxSTC_COMET_COMMENT 1
#define wxSTC_COMET_COMMAND 2
#define wxSTC_COMET_NUMBER 3
#define wxSTC_COMET_KEYWORD 4
#define wxSTC_COMET_STRING 5
#define wxSTC_COMET_OPERATOR 6
#define wxSTC_COMET_IDENTIFIER 7
#define wxSTC_COMET_DOUBLEQUOTESTRING 8
//

// [:COMET:]:160207:MOD: add SCLEX_SOLIS
#define wxSTC_LEX_SOLIS 108
#define wxSTC_SOLIS_DEFAULT 0
#define wxSTC_SOLIS_COMMENT 1
#define wxSTC_SOLIS_COMMENTLINE 2
#define wxSTC_SOLIS_COMMAND 3
#define wxSTC_SOLIS_NUMBER 4
#define wxSTC_SOLIS_KEYWORD 5
#define wxSTC_SOLIS_KEYWORD2 6
#define wxSTC_SOLIS_STRING 7
#define wxSTC_SOLIS_OPERATOR 8
#define wxSTC_SOLIS_IDENTIFIER 9
#define wxSTC_SOLIS_ERROR 10
...
//       and regenerate
    ...
    void MarkerSetAlpha(int markerNumber, int alpha);
     ...
     void setMarkersColors(unsigned long lBackModified, unsigned long lBackSaved, unsigned long lBackFind, long unsigned lBackError);
     void getMarkersColors(unsigned long *lBackModified, unsigned long *lBackSaved, unsigned long *lBackFind, long unsigned *lBackError);
     //
    ...
    // the caret should be used to provide context.
     void AutoCompShow(int lenEntered, const wxString& itemList, int iSel);
     void AutoCompUpdate(int lenEntered, const wxString& itemList, int iSel, bool bComplete);
    ...
    void AutoCompSelect(const wxString& text);
     ...
     // Select the item in the auto-completion list that starts with a string.
     // [:COMET:]:20150122:
     void AutoCompSelectRaw(const char* text);
     //

    // Select the item in the auto-completion list that has index idx.
    // [:COMET:]:20150122:
     void AutoCompSelectIndex(int idx);
    //
    ...
    int FindText(int minPos, int maxPos, const wxString& text, int flags = 0, int *findMinPos = NULL, int *findMaxPos = NULL);
    ...
    int GetCaretWidth();
     ...
     // >> SIDI 20140314
     void SetExtraAscent(int iAscent);
     void SetExtraDescent(int iDescent);
     // <<
